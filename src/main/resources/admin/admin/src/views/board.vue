...
<!-- 1 -->
		...
		<div :style='{"width":"100%","margin":"0 0 20px","alignItems":"center","background":"rgba(255,255,255,.1)","justifyContent":"center","display":"flex"}'>
			...
			<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
				<div :style='{"lineHeight":"32px","fontSize":"15px","color":"#fff","height":"32px"}'>车子离场总数</div>
...
<!-- 2 -->
		...
		<div :style='{"width":"100%","margin":"0 0 20px","alignItems":"center","background":"rgba(255,255,255,.2)","justifyContent":"center","display":"flex"}'>
			...
			<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
				<div :style='{"lineHeight":"32px","fontSize":"15px","color":"#fff","height":"32px"}'>违规处罚总数</div>
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, chezilichangChart1)
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(2, option.yAxis.data, option.series[0].data, chezilichangChart4)
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, weiguichufaChart5)
