<template>
	...
	<div class="container" :style='{"minHeight":"100vh","width":"100%","alignItems":"flex-start","background":"url(http://codegen.caihongy.cn/20230128/effb535f5a6142daa256f40fb8542933.jpg) no-repeat center bottom / 100% 100%,#fff","justifyContent":"flex-start","display":"flex"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"minHeight":"550px","padding":"20px 0 40px","boxShadow":"0 0px 0px rgba(64, 158, 255, .8)","margin":"20px 0 0 12%","borderRadius":"0","flexWrap":"wrap","background":"#fff","display":"flex","width":"44%","justifyContent":"center","height":"100%"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"padding":"0 0 10px","margin":"20px auto 40px","color":"#888","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230128/4cbad5a2e6f444188a2c08cb74dc8160.png) no-repeat center bottom","width":"700px","lineHeight":"50px","fontSize":"24px"}'>智能停车计费系统设计与实现注册</p></div>
			<el-form-item :style='{"width":"60%","padding":"0","margin":"0 auto 26px","position":"relative","height":"auto"}' v-if="tableName=='yonghu'" prop="yonghuzhanghao">
				<div v-if="true" :style='{"color":"#3e97c6","left":"-150px","textAlign":"right","width":"150px","lineHeight":"44px","fontSize":"16px","position":"absolute"}'>用户账号：</div>
				<el-input v-model="registerForm.yonghuzhanghao"  placeholder="请输入用户账号" />
			</el-form-item>
			<el-form-item :style='{"width":"60%","padding":"0","margin":"0 auto 26px","position":"relative","height":"auto"}' v-if="tableName=='yonghu'" prop="xingming">
			...
			<el-form-item :style='{"width":"60%","padding":"0","margin":"0 auto 26px","position":"relative","height":"auto"}' v-if="tableName=='yonghu'" prop="mima">
			...
			<el-form-item :style='{"width":"60%","padding":"0","margin":"0 auto 26px","position":"relative","height":"auto"}' v-if="tableName=='yonghu'" prop="xingbie">
			...
			<el-form-item :style='{"width":"60%","padding":"0","margin":"0 auto 26px","position":"relative","height":"auto"}' v-if="tableName=='yonghu'" prop="shouji">
				<div v-if="true" :style='{"color":"#3e97c6","left":"-150px","textAlign":"right","width":"150px","lineHeight":"44px","fontSize":"16px","position":"absolute"}'>手机：</div>
				<el-input v-model="registerForm.shouji"  placeholder="请输入手机" />
			</el-form-item>
			<el-form-item :style='{"width":"60%","padding":"0","margin":"0 auto 26px","position":"relative","height":"auto"}' v-if="tableName=='yonghu'" prop="touxiang">
