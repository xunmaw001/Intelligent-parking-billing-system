<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="违规事项" prop="weiguishixiang">
					<el-input v-model="ruleForm.weiguishixiang" placeholder="违规事项" clearable  :readonly="ro.weiguishixiang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="违规事项" prop="weiguishixiang">
					<el-input v-model="ruleForm.weiguishixiang" placeholder="违规事项" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="违规备注" prop="weiguibeizhu">
					<el-input v-model="ruleForm.weiguibeizhu" placeholder="违规备注" clearable  :readonly="ro.weiguibeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="违规备注" prop="weiguibeizhu">
					<el-input v-model="ruleForm.weiguibeizhu" placeholder="违规备注" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="处罚金额" prop="chufajine">
					<el-input v-model="ruleForm.chufajine" placeholder="处罚金额" clearable  :readonly="ro.chufajine"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="处罚金额" prop="chufajine">
					<el-input v-model="ruleForm.chufajine" placeholder="处罚金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="处罚时间" prop="chufashijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.chufashijian" label="处罚时间" prop="chufashijian">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `weiguichufa/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.weiguichufaCrossAddOrUpdateFlag = false;
						 this.parent.search();
