		...
		<div class="attr" :style='{"padding":"0","overflow":"hidden","borderRadius":"4px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
			...
			<div class="info" :style='{"width":"86%","padding":"10px 20px","margin":"20px 7% 20px","background":"url(http://codegen.caihongy.cn/20230127/03ad723288d44044a8b922de0a51127f.png) no-repeat left top,url(http://codegen.caihongy.cn/20230127/e1b074885e304a40bcfa7de91c22b700.png) no-repeat center bottom,#e0edf2"}'>
				...
				<div class="item" :style='{"border":"0 dashed #abd0e3","padding":"10px","margin":"0 auto 10px","background":"none","borderWidth":"0 0 1px","display":"flex","width":"90%","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#2886bc","textAlign":"right","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>违规事项</div>
					<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","height":"24px"}'>{{detail.weiguishixiang}}</div>
				</div>
				<div class="item" :style='{"border":"0 dashed #abd0e3","padding":"10px","margin":"0 auto 10px","background":"none","borderWidth":"0 0 1px","display":"flex","width":"90%","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#2886bc","textAlign":"right","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>违规备注</div>
					<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","height":"24px"}'>{{detail.weiguibeizhu}}</div>
				</div>
				<div class="item" :style='{"border":"0 dashed #abd0e3","padding":"10px","margin":"0 auto 10px","background":"none","borderWidth":"0 0 1px","display":"flex","width":"90%","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#2886bc","textAlign":"right","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>处罚金额</div>
					<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","height":"24px"}'>{{detail.chufajine}}</div>
				</div>
				<div class="item" :style='{"border":"0 dashed #abd0e3","padding":"10px","margin":"0 auto 10px","background":"none","borderWidth":"0 0 1px","display":"flex","width":"90%","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#2886bc","textAlign":"right","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>处罚时间</div>
					<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","height":"24px"}'>{{detail.chufashijian}}</div>
				</div>
				<div class="item" :style='{"border":"0 dashed #abd0e3","padding":"10px","margin":"0 auto 10px","background":"none","borderWidth":"0 0 1px","display":"flex","width":"90%","justifyContent":"spaceBetween"}'>
