...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px 0","margin":"20px 7%","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"86%","height":"auto"}'>
	  ...
	  <el-button v-if="isAuth('chezilichang','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 20px","margin":"0 4px 0 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#f4740c","width":"auto","fontSize":"14px","lineHeight":"40px ","height":"40px"}' type="primary" @click="add('/index/chezilichangAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.tingchechangmingcheng != '') searchWhere.tingchechangmingcheng = '%' + this.formSearch.tingchechangmingcheng + '%';
	      params['sfsh'] = '是';
        this.$http.get('chezilichang/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/chezilichangDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
